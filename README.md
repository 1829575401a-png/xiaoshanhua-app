...
- **核心功能**：场景化课程 + AI 发音评分 + 闯关游戏化 + 成就体系 + 待巩固（错题本）复习 + 微信社交分享（打卡/成就卡片分享给朋友，朋友圈需配海报图）
...
- [ ] 朋友圈分享海报图：在 `miniprogram/utils/share.js` 的 `SHARE_POSTER` 填入 https CDN 地址后，朋友圈分享自动启用（"发送给朋友"无需图，已可用）
